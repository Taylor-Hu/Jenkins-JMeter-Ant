...
class UnitTest02(unittest.TestCase):
    ...
    def test_checknum_1(self):
        # function = Function()
        self.assertEqual(self.function.check_number("12345"), True)
        print("test_checknum_01")

    def test_checknum_2(self):
        # function = Function()
        self.assertEqual(self.function.check_number("12.345"), True)
        print("test_checknum_02")

    def test_checknum_3(self):
        # function = Function()
        self.assertEqual(self.function.check_number("-345"), True)
        print("test_checknum_03")

    def test_checknum_10(self):
        # function = Function()
        self.assertEqual(self.function.check_number(""), False)
